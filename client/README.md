...
Important Note:  Don't let anyone else join after you start.  The game will break.  We are still jr devs... it happens. Will update this when we fix it (if we fix it haha).
...
VVVV-  All the create-react-app stuff is below  -VVVV
